...
│   ├── eval_lonly.py         # Consolidated 160-check test runner
...
│   ├── track_r_redteam.py    # Adversarial red-team / security boundary suite (83 checks)
...
1. **Zero Unverified Commits**: Run `eval/eval_lonly.py` before committing. All 160 checks must pass with exit code 0.
