...
The repository includes an offline evaluation framework (`eval/eval_lonly.py`) with **50 acceptance checks**:
...
- **Track R (R1–R5)**: Adversarial red team security suite (shell injection resilience, IPv6/CIDR TargetPolicy, URL parser confusion resistance, and below-agent broker authorization).
