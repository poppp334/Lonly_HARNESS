...
8. [Adversarial Hardening & Acceptance Suite (166/166 Checks)](#adversarial-hardening--acceptance-suite-166166-checks)
...
## Adversarial Hardening & Acceptance Suite (166/166 Checks)

LONLY maintains a unified automated acceptance test suite verifying **166 production invariants**:
...
| **Total** | **Unified Acceptance & Invariant Suite** | **166/166 PASS (100%)** |
...
- Regression coverage: `eval/track_f_privesc.py` (Track F) unit-tests the whole
  ...
  trajectory path); run with `make test` (166/166 checks).
