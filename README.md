...
8. [Adversarial Hardening & Acceptance Suite (144/144 Checks)](#adversarial-hardening--acceptance-suite-144144-checks)
...
## Adversarial Hardening & Acceptance Suite (144/144 Checks)

LONLY maintains a unified automated acceptance test suite verifying **144 production invariants**:
...
| **Total** | **Unified Acceptance & Invariant Suite** | **144/144 PASS (100%)** |
...
# 4. Run Complete 144-Check Acceptance Suite
make test
...
- Regression coverage: `eval/track_f_privesc.py` (Track F) unit-tests the whole
  ...
  trajectory path); run with `make test` (144/144 checks).
...
├── eval/                              # Acceptance & Evaluation Suite (144/144 checks)
